...
def diagnose():
    ...
    try:
        ...
        **reason 작성 규칙 (원인 분석):**
        ...
        - Y 등급: 지침서에서 충족하는 구체적 내용 요약
        - P 등급: 지침서에 일부만 있거나 불완전한 이유를 명확히 설명
        - N 등급: 지침서에 해당 내용이 없거나 부족한 이유를 구체적으로 설명
        
        **countermeasure 작성 규칙 (개선 방안):**
        - Y 등급: "현재 수준 유지" 또는 간단한 유지 방안
        - P 등급: 불완전한 부분을 보완하기 위한 구체적이고 실행 가능한 조치 방안 (2-3가지)
        - N 등급: 해당 항목을 충족하기 위한 명확하고 실행 가능한 조치 방안 (3-4가지)
